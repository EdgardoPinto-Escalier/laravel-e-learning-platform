<li><a class="nav-link" href="{{ url('/home') }}"><i class="fas fa-clipboard-list"></i>&nbsp; {{ ("COURSE LIST") }}</a></li>

<li class="nav-item dropdown">
  <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <i class="fas fa-external-link-alt"></i>&nbsp; MY TEACHER ACCESS LINKS
  </a>
  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <a class="dropdown-item" href="{{ route('teacher.courses')}}"><i class="fas fa-wrench fa-lg"></i>&nbsp; {{ ("COURSES DEVELOPED BY ME") }}</a>
    <a class="dropdown-item" href="{{ route('courses.create') }}"><i class="fas fa-wrench fa-lg"></i>&nbsp; {{ ("CREATE COURSE") }}</a>
  </div>
</li>
