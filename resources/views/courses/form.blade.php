...
@section('jumbotron')
    @include('partials.jumbotron', ['title' => 'CREATE A NEW COURSE', 'icon' => 'edit'], ['subtitle' => 'HERE YOU CAN CREATE NEW COURSES USING THE FORM BELOW'])
@endsection
...
@section('content')
    <div class="pl-5 pr-5">
        ...
        >
            <!-- If we are in editing mode we use the PUT method. -->
            @if($course->id)
                @method('PUT')
            @endif
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header basic">
                            <i class="fas fa-info-circle"></i>&nbsp; {{ ("BASIC INFORMATION ABOUT THE NEW COURSE") }}
                        </div>
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="category_id" class="col-md-4 col-form-label text-md-right">{{ ("COURSE CATEGORY") }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group ml-3 mr-2">
                            <div class="col-sm-offset-0 col-md-6 offset-4">
                                ...
                                <p class="imagePreferredSize"><small>Preferred size: 500 px width x 250 px height with the file types: .jpg/.jpeg/.png</small></p>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header requirements"><i class="fas fa-clipboard-list"></i>&nbsp; {{ ("REQUIREMENTS") }}</div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label
                                    for="requirement1"
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header achievements"><i class="fas fa-check"></i>&nbsp; {{ ("WHAT WILL THE STUDENT ACHIEVE AT THE END OF THE COURSE?") }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="goal2" class="col-sm-4 col-form-label text-md-right">
                                    {{ ("ACHIEVEMENT 2") }}
                                </label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group row mb-0 d-flex justify-content-center">
                                <div class="col-md-6 d-flex d-flex justify-content-center">
                                    <button type="submit" name="revision" class="btn btnSubmitCourseReview d-flex">
